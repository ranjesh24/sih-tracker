...
Specifications live in `../SIH_md_files/`. They are the source of truth. Code that contradicts them is a defect.

| File | Read it when |
|---|---|
| `../SIH_md_files/rules.md` | **Always. Every session, before any code.** |
| `../SIH_md_files/prd.md` | Understanding what a feature is for, or checking an acceptance criterion |
| `../SIH_md_files/techspec.md` | Any dependency, endpoint, auth, or config question |
| `../SIH_md_files/schema.md` | Anything touching the database |
| `../SIH_md_files/appflow.md` | Any frontend route, state, error, or empty state |
| `../SIH_md_files/design.md` | Any UI work at all |
| `../SIH_md_files/implementationplan.md` | Understanding phase order and verification gates |
| `../SIH_md_files/tracker.md` | **Before starting and after finishing any task** |
...
Full text in `../SIH_md_files/rules.md` §1. Summarised because they matter most:
...
Full system in `../SIH_md_files/design.md`. The hard prohibitions, because they are absolute:
...
Check `../SIH_md_files/tracker.md`. It is the live status of every task.

Phase order is defined in `../SIH_md_files/implementationplan.md`. Do not start a phase before the previous phase's gate block is fully `[x]`. Gates are verified by running the commands, not by inspection.
